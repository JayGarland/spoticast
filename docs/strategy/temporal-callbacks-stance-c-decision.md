...
The market competition analysis (`docs/research/Resonova-analysis-market-competition.md`) identified "long-term listening trails → personal memory → evolving narrated cast" as Resonova's defensible moat. Temporal callbacks at the pattern level are the mechanism that makes that moat real in the hosts' voice.
...
- `docs/strategy/bounded-personal-music-narrator-pivot.md` — Stance C product pivot (2026-06-23)
- `docs/handoffs/Host Awareness Decision Discussion Handoff.md` — Stance A/B/C definitions
- `docs/research/Resonova-analysis-market-competition.md` — temporal callbacks as moat
- `docs/strategy/companion-direction-and-memory-use-brief.md` — memory control model
